...
export const Header = (
    ...
    <>
      <Popover as="header" className="bg-gradient-to-r from-sky-200 to-cyan-400 pb-24">
        {({open}) => (
            <>
              <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-full lg:px-8">
                <div className="relative flex flex-wrap items-center justify-center lg:justify-between">
                  ...
                  <div className="absolute left-0 flex-shrink-0 py-5 lg:static">
                    <a href="/">
                      <span className="sr-only">Apply Digital</span>
                      <Image
                        ...
                        <nav className="flex space-x-4">
                          {navigation?.map((item) => (
                              <Link
                                  ...
                                  className={classNames(item.current ? 'text-black font-extrabold' : 'text-gray-800',
